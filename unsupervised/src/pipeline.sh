...
python3 1_train_new_moe.py model=$MODEL dataset=$DATASET testing=$DATASET model.adapters.use_adapters=True model.adapters.num_experts=6 model.init.specialized_mode=sbmoe_all
...
python3 1_train_new_moe.py model=$MODEL dataset=$DATASET testing=$DATASET model.adapters.use_adapters=True model.adapters.num_experts=6 model.init.specialized_mode=sbmoe_top1
TESTING_DATASET=$DATASET
